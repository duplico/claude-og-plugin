...
Project-specific rules start at Rule 11 and are numbered per project.

---

## Universal Rules (0-10)
...
## Project-Specific Rules (11+)

A project's `<repo>/.claude/skills/<project>-orchestrator/SKILL.md` (generated by `/og:orchestrate-init`) may define additional rules starting at Rule 11. These are numbered independently per project.
